...
(in-package :stumpwm)
(defcommand winfirefox () () (sb-thread:make-thread (lambda () (sb-ext:run-program "/home/jacob/Desktop/ffx.sh" '("")))))
(define-key *root-map* (kbd "d") "exec firefox-beta")
(define-key *root-map* (kbd "c") "exec urxvtc -e ion")
